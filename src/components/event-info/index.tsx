    ...
    return (
        <section className={styles.eventInfo}>
            ...
            <div className={styles.textWrapper}>
                ...
                <h3>Mobile Apps <a href="" target="_blank"><img className={styles.outgoingLinkIcon} src={GET_ON_GOOGLE_PLAY} /></a> <a href="" target="_blank"><img className={styles.outgoingLinkIcon} src={DOWNLOAD_ON_APP_STORE} /></a></h3>
