...
const interestOptions = [
    ...
    {
        label: "Mini-Events (e.g. game tournaments)",
        value: "Mini-Events (e.g. game tournaments)"
    },
    ...
    {
        label: "Pitching Shark Tank projects",
        value: "Pitching Shark Tank projects"
    },
...
const Event = (): JSX.Element => (
    ...
    <div>
        ...
        <p className={styles.text}>
            Which of these aspects of the hackathon would you most be interested
            in engaging in?
        </p>
        <Checkboxes
